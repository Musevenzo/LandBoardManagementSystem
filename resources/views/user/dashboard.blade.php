<x-layouts.app title="User  Dashboard">
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-6 rounded-xl bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div class="flex gap-4 mb-6">
            <a href="{{ route('user.applications.create') }}" class="p-4 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition">New Application</a>
            <a href="{{ route('user.applications.index') }}" class="p-4 bg-green-600 text-white rounded-lg shadow-md hover:bg-green-700 transition">View Application Status</a>
            <a href="{{ route('user.applications.index') }}" class="p-4 bg-purple-600 text-white rounded-lg shadow-md hover:bg-purple-700 transition">Application History</a>
        </div>
